public class Main {
    public static void main(String[] args) {
        ...
        var worker=totalTime/timeWorker;
        System.out.println("Всего работников в компании - " +worker+ " человек");

        var newWorker=worker+94;
        var newTimeWorker=newWorker*timeWorker;
        System.out.println("Если в компании работает " +newWorker+ " человека, то всего " +newTimeWorker+ " часов работы может быть поделено между сотрудниками");
    }
}